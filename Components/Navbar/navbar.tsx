    ...
    <>
      <nav className='bg-primary'>
        <ul className='d-flex justify-content-around gap-2 px-0'>
          ...
          <ButtonNav index={2} state={isActive} onshow={() => onshow(2)}>Regiões/Ocupação</ButtonNav>
          <ButtonNav index={3} state={isActive} onshow={() => onshow(3)}>Medidas de segurança</ButtonNav>
        </ul>
      </nav>
    </>
  )
